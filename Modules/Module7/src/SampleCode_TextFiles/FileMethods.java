...
class FileMethods {
    ...
    public static void main(String[] args) {
        File testFile = new File("src\\SampleCode_TextFiles\\SampleFile.txt");                      //Declares a File object variable named testFile. Instantiates the File object by providing the path to the file.
